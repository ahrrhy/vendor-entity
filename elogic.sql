...
INSERT INTO `admin_passwords` VALUES (1,1,'b6a5ce1101a6572c5c06395280a096d68b7406746e33fcdb2ad6acf50b011fa0:RSmNKmosGcBP9LPAgDiIibwEMZOFyFIq:1',0,1557608927);
...
INSERT INTO `admin_user` VALUES (1,'elogic','elogic','ahrrhy@gmail.com','elogic','b6a5ce1101a6572c5c06395280a096d68b7406746e33fcdb2ad6acf50b011fa0:RSmNKmosGcBP9LPAgDiIibwEMZOFyFIq:1','2019-05-11 21:08:47','2019-05-23 18:01:29','2019-05-23 18:01:29',12,0,1,'{\"configState\":{\"admin_security\":\"1\",\"admin_emails\":\"0\",\"admin_startup\":\"0\",\"admin_url\":\"0\",\"admin_dashboard\":\"0\",\"admin_captcha\":\"1\",\"msp_securitysuite_twofactorauth_authy\":\"0\",\"system_backup\":\"0\"}}',NULL,NULL,'en_US',0,NULL,NULL,NULL);
...
INSERT INTO `authorization_role` VALUES (1,0,1,1,'G',0,'2','Administrators'),(2,1,2,0,'U',1,'2','elogic');
...
INSERT INTO `catalog_category_entity` VALUES (1,3,0,'2019-05-11 21:08:44','2019-05-11 21:08:44','1',0,0,1),(2,3,1,'2019-05-11 21:08:44','2019-05-11 21:08:44','1/2',1,1,0);
...
INSERT INTO `catalog_category_product_index_store1` VALUES (2,1,0,0,1,4);
...
INSERT INTO `catalog_product_entity` VALUES (1,4,'virtual','Test Elogic Product',0,0,'2019-05-19 17:17:27','2019-05-19 17:17:27');
...
INSERT INTO `catalog_product_entity_decimal` VALUES (1,77,0,1,12.0000),(2,82,0,1,0.0000);
...
INSERT INTO `catalog_product_entity_int` VALUES (1,97,0,1,1),(2,99,0,1,4),(3,129,0,1,0);
...
INSERT INTO `catalog_product_entity_varchar` VALUES (1,73,0,1,'Test Elogic Product'),(2,84,0,1,'Test Elogic Product'),(3,86,0,1,'Test Elogic Product Where does it come from?\r\nContrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hamp'),(4,106,0,1,'container2'),(5,118,0,1,'0'),(6,121,0,1,'test-elogic-product'),(7,127,0,1,'2');
...
INSERT INTO `catalog_product_index_price` VALUES (1,0,1,0,12.0000,12.0000,12.0000,12.0000,NULL),(1,1,1,0,12.0000,12.0000,12.0000,12.0000,NULL),(1,2,1,0,12.0000,12.0000,12.0000,12.0000,NULL),(1,3,1,0,12.0000,12.0000,12.0000,12.0000,NULL);
...
INSERT INTO `catalog_product_index_website` VALUES (1,1,'2019-05-19',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='Visitor Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `email_catalog` VALUES (1,1,NULL,NULL,'2019-05-19 17:17:27','2019-05-19 17:17:27');
...
INSERT INTO `inventory_low_stock_notification_configuration` VALUES ('default','Test Elogic Product',NULL);
...
INSERT INTO `inventory_source_item` VALUES (1,'default','Test Elogic Product',1000.0000,1);
...
--
-- Table structure for table `vendor_entity`
--
...
CREATE TABLE `vendor_entity` (
  ...
  `vendor_logo` varchar(255) DEFAULT NULL COMMENT 'Vendor Logo',
  `vendor_description` varchar(255) DEFAULT NULL COMMENT 'Vendor Description',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation Time',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Update Time',
  PRIMARY KEY (`entity_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Vendor Table';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vendor_entity`
--

LOCK TABLES `vendor_entity` WRITE;
/*!40000 ALTER TABLE `vendor_entity` DISABLE KEYS */;
INSERT INTO `vendor_entity` VALUES (1,'test vendor',NULL,'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.','2019-05-21 18:03:03','2019-05-21 18:08:59'),(2,'all deals shop',NULL,'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.','2019-05-21 18:09:49','2019-05-22 20:36:45');
/*!40000 ALTER TABLE `vendor_entity` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vendor_entity_datetime`
--

DROP TABLE IF EXISTS `vendor_entity_datetime`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vendor_entity_datetime` (
  ...
  `value` datetime DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `VENDOR_ENTITY_DATETIME_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `VENDOR_ENTITY_DATETIME_ATTRIBUTE_ID` (`attribute_id`),
  KEY `VENDOR_ENTITY_DATETIME_STORE_ID` (`store_id`),
  CONSTRAINT `VENDOR_ENTITY_DATETIME_ATTRIBUTE_ID_EAV_ATTRIBUTE_ATTRIBUTE_ID` FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute` (`attribute_id`) ON DELETE CASCADE,
  CONSTRAINT `VENDOR_ENTITY_DATETIME_ENTITY_ID_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `vendor_entity` (`entity_id`) ON DELETE CASCADE,
  CONSTRAINT `VENDOR_ENTITY_DATETIME_STORE_ID_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `store` (`store_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='vendor Datetime Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vendor_entity_datetime`
--

LOCK TABLES `vendor_entity_datetime` WRITE;
/*!40000 ALTER TABLE `vendor_entity_datetime` DISABLE KEYS */;
/*!40000 ALTER TABLE `vendor_entity_datetime` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vendor_entity_decimal`
--

DROP TABLE IF EXISTS `vendor_entity_decimal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vendor_entity_decimal` (
  ...
  `value` decimal(12,4) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `VENDOR_ENTITY_DECIMAL_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `VENDOR_ENTITY_DECIMAL_STORE_ID` (`store_id`),
  KEY `VENDOR_ENTITY_DECIMAL_ATTRIBUTE_ID` (`attribute_id`),
  CONSTRAINT `VENDOR_ENTITY_DECIMAL_ATTRIBUTE_ID_EAV_ATTRIBUTE_ATTRIBUTE_ID` FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute` (`attribute_id`) ON DELETE CASCADE,
  CONSTRAINT `VENDOR_ENTITY_DECIMAL_ENTITY_ID_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `vendor_entity` (`entity_id`) ON DELETE CASCADE,
  CONSTRAINT `VENDOR_ENTITY_DECIMAL_STORE_ID_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `store` (`store_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Vendor Decimal Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vendor_entity_decimal`
--

LOCK TABLES `vendor_entity_decimal` WRITE;
/*!40000 ALTER TABLE `vendor_entity_decimal` DISABLE KEYS */;
/*!40000 ALTER TABLE `vendor_entity_decimal` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vendor_entity_int`
--

DROP TABLE IF EXISTS `vendor_entity_int`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vendor_entity_int` (
  ...
  `value` int(11) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `VENDOR_ENTITY_INT_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `VENDOR_ENTITY_INT_ATTRIBUTE_ID` (`attribute_id`),
  KEY `VENDOR_ENTITY_INT_STORE_ID` (`store_id`),
  CONSTRAINT `VENDOR_ENTITY_INT_ATTRIBUTE_ID_EAV_ATTRIBUTE_ATTRIBUTE_ID` FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute` (`attribute_id`) ON DELETE CASCADE,
  CONSTRAINT `VENDOR_ENTITY_INT_ENTITY_ID_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `vendor_entity` (`entity_id`) ON DELETE CASCADE,
  CONSTRAINT `VENDOR_ENTITY_INT_STORE_ID_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `store` (`store_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Vendor Integer Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vendor_entity_int`
--

LOCK TABLES `vendor_entity_int` WRITE;
/*!40000 ALTER TABLE `vendor_entity_int` DISABLE KEYS */;
/*!40000 ALTER TABLE `vendor_entity_int` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vendor_entity_text`
--

DROP TABLE IF EXISTS `vendor_entity_text`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vendor_entity_text` (
  ...
  `value` text COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `VENDOR_ENTITY_TEXT_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `VENDOR_ENTITY_TEXT_ATTRIBUTE_ID` (`attribute_id`),
  KEY `VENDOR_ENTITY_TEXT_STORE_ID` (`store_id`),
  CONSTRAINT `VENDOR_ENTITY_TEXT_ATTRIBUTE_ID_EAV_ATTRIBUTE_ATTRIBUTE_ID` FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute` (`attribute_id`) ON DELETE CASCADE,
  CONSTRAINT `VENDOR_ENTITY_TEXT_ENTITY_ID_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `vendor_entity` (`entity_id`) ON DELETE CASCADE,
  CONSTRAINT `VENDOR_ENTITY_TEXT_STORE_ID_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `store` (`store_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Vendor Text Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vendor_entity_text`
--

LOCK TABLES `vendor_entity_text` WRITE;
/*!40000 ALTER TABLE `vendor_entity_text` DISABLE KEYS */;
/*!40000 ALTER TABLE `vendor_entity_text` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vendor_entity_varchar`
--

DROP TABLE IF EXISTS `vendor_entity_varchar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vendor_entity_varchar` (
  ...
  `value` varchar(255) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `VENDOR_ENTITY_VARCHAR_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `VENDOR_ENTITY_VARCHAR_ATTRIBUTE_ID` (`attribute_id`),
  KEY `VENDOR_ENTITY_VARCHAR_STORE_ID` (`store_id`),
  CONSTRAINT `VENDOR_ENTITY_VARCHAR_ATTRIBUTE_ID_EAV_ATTRIBUTE_ATTRIBUTE_ID` FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute` (`attribute_id`) ON DELETE CASCADE,
  CONSTRAINT `VENDOR_ENTITY_VARCHAR_ENTITY_ID_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `vendor_entity` (`entity_id`) ON DELETE CASCADE,
  CONSTRAINT `VENDOR_ENTITY_VARCHAR_STORE_ID_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `store` (`store_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Vendor Varchar Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vendor_entity_varchar`
--

LOCK TABLES `vendor_entity_varchar` WRITE;
/*!40000 ALTER TABLE `vendor_entity_varchar` DISABLE KEYS */;
/*!40000 ALTER TABLE `vendor_entity_varchar` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-05-24  8:13:55
